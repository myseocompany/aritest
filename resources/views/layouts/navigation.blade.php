<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <!-- User Settings / Auth Links -->
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                @auth
                    <!-- Menu de usuario autenticado (Profile y Logout) -->
                    <div class="space-x-4">
                ...
                @else
                    <!-- Links de Login y Register -->
                    <div class="space-x-4">
                        <a href="{{ route('login') }}" class="text-sm font-medium text-gray-500 hover:text-gray-700">
                            {{ __('Login') }}
                        </a>
                        <a href="{{ route('register') }}" class="text-sm font-medium text-gray-500 hover:text-gray-700">
                            {{ __('Register') }}
                        </a>
                    </div>
                @endauth
